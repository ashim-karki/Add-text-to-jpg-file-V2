...
for i in range(1,len(data)):
    ...
    I1.text((1450, 365), data[i][0], font=myFont1, fill =(255, 255, 255), align='center') # this can't be used in a for loop
    I1.text((1650, 465), data[i][1], font=myFont2, fill =(255, 255, 255), align='center') 
    I1.text((1200, 465), data[i][2], font=myFont3, fill =(255, 255, 255), align='center')
